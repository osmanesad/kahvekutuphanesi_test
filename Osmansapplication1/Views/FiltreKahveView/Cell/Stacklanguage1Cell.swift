...
struct Stacklanguage1Cell: View {
        ...
        ZStack(alignment: .center) {
            ...
            ZStack {}
                ...
                .frame(width: getRelativeWidth(152.0), height: getRelativeHeight(341.0),
                       alignment: .leading)
                .background(ColorConstants.Yellow50)
            ...
            VStack {
                Text(StringConstants.kMsgLatinAmerikaK)
                    ...
                    .minimumScaleFactor(0.5)
                    .multilineTextAlignment(.leading)
                    .frame(width: getRelativeWidth(100.0), height: getRelativeHeight(76.0),
                           alignment: .leading)
                    .padding(.vertical, getRelativeHeight(228.0))
...
/* struct Stacklanguage1Cell_Previews: PreviewProvider {
