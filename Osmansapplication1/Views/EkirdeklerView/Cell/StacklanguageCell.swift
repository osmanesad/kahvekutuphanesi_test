        ...
        ZStack(alignment: .center) {
            ...
            ZStack {}
                ...
                .frame(width: getRelativeWidth(152.0), height: getRelativeHeight(341.0),
                       alignment: .leading)
                .background(ColorConstants.LightGreenA100)
            ...
            VStack {
                Text(StringConstants.kLblFiltreKahve)
                    ...
                    .minimumScaleFactor(0.5)
                    .multilineTextAlignment(.leading)
                    .frame(width: getRelativeWidth(66.0), height: getRelativeHeight(47.0),
                           alignment: .leading)
...
/* struct StacklanguageCell_Previews: PreviewProvider {
